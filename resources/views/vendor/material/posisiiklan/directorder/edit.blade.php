...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Direct Order<small>Edit Direct Order</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('posisi-iklan/direct-order/' . $summaryitem->summary_item_id) }}">
        		{{ csrf_field() }}
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_title" id="summary_item_title" placeholder="Title" required="true" maxlength="100" value="{{ $summaryitem->summary_item_title }}">
	                    </div>
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <select name="client_id" id="client_id" class="selectpicker" data-live-search="true" required="true">
	                        	<option value="{{ $summaryitem->client_id }}" selected>{{ $summaryitem->client->client_name }}</option>
                            </select>
	                    </div>
	                    ...
	                    <div class="fg-line">
	                        <select name="industry_id" id="industry_id" class="selectpicker" data-live-search="true" required="true">
                                ...
                                @foreach ($industry as $row)
                                	{!! $selected = '' !!}
                                	@if($row->industry_id==$summaryitem->industry_id)
                                		{!! $selected = 'selected' !!}
                                	@endif
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <select name="rate_id" id="rate_id" class="selectpicker" data-live-search="true" required="true">
	                        	<option value="{{ $summaryitem->rate_id }}" selected>{{ $summaryitem->rate->rate_name }}</option>
                            </select>
                            <input type="hidden" name="base_rate" id="base_rate" value="{{ $summaryitem->rate->gross_rate }}">
	                    </div>
	                    ...
	                    <div class="fg-line">
	                        <div class="input-group form-group">
                                ...
                                <div class="dtp-container fg-line">
                                    <input type="text" class="form-control date-picker" name="summary_item_period_start" id="summary_item_period_start" placeholder="dd/mm/yyyy" required="true" maxlength="10" value="{{ $summary_item_period_start }}">
                                </div>
                            </div>
	                    </div>
	                ...
	                <div class="col-sm-3">
	                    <div class="fg-line">
	                        <div class="input-group form-group">
                                <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                <div class="dtp-container fg-line">
                                    <input type="text" class="form-control date-picker" name="summary_item_period_end" id="summary_item_period_end" placeholder="dd/mm/yyyy (Not Required)" maxlength="10" value="{{ $summary_item_period_end }}">
                                </div>
                            </div>
	                    </div>
	                    ...
	                    <div class="fg-line">
	                        <select name="omzet_type_id" id="omzet_type_id" class="selectpicker" data-live-search="true" required="true">
                                ...
                                @foreach ($omzettypes as $row)
                                	{!! $selected = '' !!}
                                	@if($row->omzet_type_id==$summaryitem->omzet_type_id)
                                		{!! $selected = 'selected' !!}
                                	@endif
	                    ...
	                    <div class="fg-line">
	                        <select name="summary_item_type" id="summary_item_type" class="selectpicker" data-live-search="true" required="true">
                                ...
                                @foreach ($summary_item_types as $row)
                                	{!! $selected = '' !!}
                                	@if($row==$summaryitem->summary_item_type)
                                		{!! $selected = 'selected' !!}
                                	@endif
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="number" class="form-control input-sm" name="summary_item_insertion" id="summary_item_insertion"  required="true" placeholder="0" maxlength="100" value="{{ $summaryitem->summary_item_insertion }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_gross" id="summary_item_gross" placeholder="0" required="true" maxlength="100" value="{{ $summaryitem->summary_item_gross }}" readonly="true">
	                    </div>
	               	...
	               	<div class="col-sm-2">
	               		<span class="badge" id="format_summary_item_gross">{{ number_format($summaryitem->summary_item_gross) }}</span>
	               	</div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_nett" id="summary_item_nett" placeholder="0" required="true" maxlength="100" value="{{ $summaryitem->summary_item_nett }}">
	                    </div>
	               	...
	               	<div class="col-sm-2">
	               		<span class="badge" id="format_summary_item_nett">{{ number_format($summaryitem->summary_item_nett) }}</span>
	               	</div>
	               	<label for="summary_item_po" class="col-sm-2 control-label">PO</label>
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_po" id="summary_item_po" placeholder="0" required="true" maxlength="100" value="{{ $summaryitem->summary_item_po }}">
	                    </div>
	               	...
	               	<div class="col-sm-2">
	               		<span class="badge" id="format_summary_item_po">{{ number_format($summaryitem->summary_item_po) }}</span>
	               	</div>
	            </div>
	            <div class="form-group">
	                ...
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_ppn" id="summary_item_ppn" placeholder="0" required="true" maxlength="100" value="{{ $summaryitem->summary_item_ppn }}" readonly="true">
	                    </div>
	               	...
	               	<div class="col-sm-2">
	               		<span class="badge" id="format_summary_item_ppn">{{ number_format($summaryitem->summary_item_ppn) }}</span>
	               	</div>
	               	<label for="summary_item_internal_omzet" class="col-sm-2 control-label">Internal Omzet</label>
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_internal_omzet" id="summary_item_internal_omzet" placeholder="0" required="true" maxlength="100" value="{{ $summaryitem->summary_item_internal_omzet }}">
	                    </div>
	               	...
	               	<div class="col-sm-2">
	               		<span class="badge" id="format_summary_item_internal_omzet">{{ number_format($summaryitem->summary_item_internal_omzet) }}</span>
	               	</div>
	            </div>
	            <div class="form-group">
	                ...
	                <div class="col-sm-2">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_total" id="summary_item_total" placeholder="0" required="true" maxlength="100" value="{{ $summaryitem->summary_item_total }}" readonly="true">
	                    </div>
	               	...
	               	<div class="col-sm-2">
	               		<span class="badge" id="format_summary_item_total">{{ number_format($summaryitem->summary_item_total) }}</span>
	               	</div>
	               	<div class="col-sm-6">
	               		<button type="button" id="btn-recalculate" class="btn btn-warning">Recalculate</button>
	               	</div>
	            </div>
	            <hr/>
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="page_no" id="page_no" placeholder="Halaman (Not Required)" maxlength="100" value="{{ $summaryitem->page_no }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_canal" id="summary_item_canal" placeholder="Kanal (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_canal }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_order_digital" id="summary_item_order_digital" placeholder="Order Digital (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_order_digital }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_materi" id="summary_item_materi" placeholder="Materi (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_materi }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_status_materi" id="summary_item_status_materi" placeholder="Status Materi (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_status_materi }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_capture_materi" id="summary_item_capture_materi" placeholder="Capture Materi (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_capture_materi }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_sales_order" id="summary_item_sales_order" placeholder="Sales Order (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_sales_order }}">
	                    </div>
	                    ...
	                    <div class="fg-line">
	                        <select name="summary_item_viewed" id="summary_item_viewed" class="selectpicker" data-live-search="true" required="true">
                                ...
                                @foreach ($summary_item_viewed as $row)
                                	{!! $selected = '' !!}
                                	@if($row==$summaryitem->summary_item_viewed)
                                		{!! $selected = 'selected' !!}
                                	@endif
								    <option value="{{ $row }}" {{ $selected }}>{{ $row  }}</option>
								@endforeach
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="summary_item_remarks" id="summary_item_remarks" placeholder="Remarks (Not Required)" maxlength="100" value="{{ $summaryitem->summary_item_remarks }}">
	                    </div>
