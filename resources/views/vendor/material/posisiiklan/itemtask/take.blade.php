        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('posisi-iklan/item_task/take/' . $summaryitem->summary_item_id) }}">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" name="posisi_iklan_item_page_no" id="posisi_iklan_item_page_no" class="form-control input-sm" readonly="true" placeholder="Halaman/Posisi" value="{{ $summaryitem->page_no }}">
	                    </div>
	                </div>
	            </div>
	            <div class="form-group">
