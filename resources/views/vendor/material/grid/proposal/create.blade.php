...
@section('content')
    <div class="card">
        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('grid/proposal') }}">
        		{{ csrf_field() }}
	            <div class="form-group">
	                <label for="grid_proposal_name" class="col-sm-2 control-label">Proposal Name</label>
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="grid_proposal_name" id="grid_proposal_name" placeholder="Proposal Name" required="true" maxlength="100" value="{{ old('grid_proposal_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm date-picker" name="grid_proposal_deadline" id="grid_proposal_deadline" placeholder="Deadline" required="true" maxlength="10" value="{{ old('grid_proposal_deadline') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="grid_proposal_desc" id="grid_proposal_desc" class="form-control input-sm" placeholder="Description">{{ old('grid_proposal_desc') }}</textarea>
	                    </div>
