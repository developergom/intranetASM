...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Brands Management<small>Create New Brand</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/brand') }}">
        		{{ csrf_field() }}
	                    ...
	                    <div class="fg-line">
	                        <select name="subindustry_id" id="subindustry_id" class="selectpicker" data-live-search="true" required="true">
                                ...
                                @foreach ($subindustry as $row)
                                	{!! $selected = '' !!}
                                	@if($row->subindustry_id==old('subindustry_id'))
                                		{!! $selected = 'selected' !!}
        		...
        		<div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="brand_code" id="brand_code" placeholder="Brand Code" required="true" maxlength="15" value="{{ old('brand_code') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="brand_name" id="brand_name" placeholder="Brand Name" required="true" maxlength="100" value="{{ old('brand_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="brand_desc" id="brand_desc" class="form-control input-sm" placeholder="Description">{{ old('brand_desc') }}</textarea>
	                    </div>
