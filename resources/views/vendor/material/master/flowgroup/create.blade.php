...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Flow Groups Management<small>Create New Flow Group</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/flowgroup') }}">
        		{{ csrf_field() }}
	            <div class="form-group">
	                <label for="flow_group_name" class="col-sm-2 control-label">Flow Group Name</label>
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="flow_group_name" id="flow_group_name" placeholder="Flow Group Name" required="true" maxlength="100" value="{{ old('flow_group_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="flow_group_desc" id="flow_group_desc" class="form-control input-sm" placeholder="Description">{{ old('flow_group_desc') }}</textarea>
	                    </div>
