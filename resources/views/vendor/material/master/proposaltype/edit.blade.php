        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/proposaltype/'.$proposaltype->proposal_type_id) }}">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="proposal_type_duration" id="proposal_type_duration" placeholder="Proposal Type Duration (day)" required="true" maxlength="2" value="{{ $proposaltype->proposal_type_duration }}">
	                    </div>
