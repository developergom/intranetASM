...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Clients Management<small>Edit Client</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/client/' . $client->client_id) }}" enctype="multipart/form-data">
        		{{ csrf_field() }}
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                    	<select name="client_type_id" id="client_type_id" class="chosen" required="true">
	                        	<option value=""></option>
                                @foreach ($clienttype as $row)
                                	{!! $selected = '' !!}
                                	@if($row->client_type_id==$client->client_type_id)
                                		{!! $selected = 'selected' !!}
                                	@endif
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="client_name" id="client_name" placeholder="Client Name" required="true" maxlength="255" value="{{ $client->client_name }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="client_formal_name" id="client_formal_name" placeholder="Client Formal Name" required="true" maxlength="255" value="{{ $client->client_formal_name }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="client_mail_address" id="client_mail_address" class="form-control input-sm" placeholder="Mail Address">{{ $client->client_mail_address }}</textarea>
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="client_mail_postcode" id="client_mail_postcode" placeholder="Post Code" required="true" maxlength="10" value="{{ $client->client_mail_postcode }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="client_phone" id="client_phone" placeholder="Phone No" required="true" maxlength="15" value="{{ $client->client_phone }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="client_fax" id="client_fax" placeholder="Fax No" maxlength="15" value="{{ $client->client_fax }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="client_email" id="client_email" placeholder="Email" required="true" maxlength="255" value="{{ $client->client_email }}">
	                    </div>
