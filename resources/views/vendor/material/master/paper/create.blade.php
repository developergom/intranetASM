...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Paper Types Management<small>Create New Paper Type</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/paper') }}">
        		{{ csrf_field() }}
	            <div class="form-group">
	                <label for="paper_name" class="col-sm-2 control-label">Name</label>
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="paper_name" id="paper_name" placeholder="Paper Name" required="true" maxlength="100" value="{{ old('paper_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="paper_width" id="paper_width" placeholder="Paper Width" required="true" maxlength="10" value="{{ old('paper_width') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="paper_length" id="paper_length" placeholder="Paper Length" required="true" maxlength="10" value="{{ old('paper_length') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="paper_desc" id="paper_desc" class="form-control input-sm" placeholder="Description">{{ old('paper_desc') }}</textarea>
	                    </div>
