        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/mediagroup') }}">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="media_group_code" id="media_group_code" placeholder="Media Group Code" required="true" maxlength="5" value="{{ old('media_group_code') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="media_group_name" id="media_group_name" placeholder="Media Group Name" required="true" maxlength="100" value="{{ old('media_group_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="media_group_desc" id="media_group_desc" class="form-control input-sm" placeholder="Description">{{ old('media_group_desc') }}</textarea>
	                    </div>
