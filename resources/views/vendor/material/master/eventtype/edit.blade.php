        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/eventtype/'.$eventtype->event_type_id) }}">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="event_type_name" id="event_type_name" placeholder="Action Type Name" required="true" maxlength="100" value="{{ $eventtype->event_type_name }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="event_type_desc" id="event_type_desc" class="form-control input-sm" placeholder="Description">{{ $eventtype->event_type_desc }}</textarea>
	                    </div>
