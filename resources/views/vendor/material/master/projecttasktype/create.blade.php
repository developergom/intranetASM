...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Project Task Types Management<small>Create New Project Task Type</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/projecttasktype') }}">
        		{{ csrf_field() }}
	            <div class="form-group">
	                <label for="project_task_type_name" class="col-sm-2 control-label">Name</label>
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="project_task_type_name" id="project_task_type_name" placeholder="Project Task Type Name" required="true" maxlength="100" value="{{ old('project_task_type_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="project_task_type_desc" id="project_task_type_desc" class="form-control input-sm" placeholder="Description">{{ old('project_task_type_desc') }}</textarea>
	                    </div>
