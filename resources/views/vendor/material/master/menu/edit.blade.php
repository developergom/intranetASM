...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Module Management<small>Edit Module</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/module/'.$module->module_id) }}">
        		{{ csrf_field() }}
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="module_url" id="module_url" placeholder="Module URL" required="true" maxlength="100" value="{{ $module->module_url }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="module_desc" id="module_desc" class="form-control input-sm" placeholder="Description">{{ $module->module_desc }}</textarea>
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <select name="action_id[]" id="action_id" class="chosen" multiple required="true">
	                        	<option value=""></option>
