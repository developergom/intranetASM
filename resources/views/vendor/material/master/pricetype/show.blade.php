        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form">
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="price_type_name" id="price_type_name" placeholder="Price Type Name" required="true" maxlength="100" value="{{ $pricetype->price_type_name }}" readonly="true">
	                    </div>
	                </div>
	            </div>
	            <div class="form-group">
