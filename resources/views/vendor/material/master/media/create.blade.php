        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/media') }}" enctype="multipart/form-data">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="media_circulation" id="media_circulation" placeholder="Media Circulation ex: 50000" maxlength="10" value="{{ old('media_circulation') }}">
	                    </div>
