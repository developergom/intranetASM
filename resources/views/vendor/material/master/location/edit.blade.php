...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Location Management<small>Edit Location</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/location/'.$location->location_id) }}">
        		{{ csrf_field() }}
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="location_name" id="location_name" placeholder="Media Location Name" required="true" maxlength="100" value="{{ $location->location_name }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="location_desc" id="location_desc" class="form-control input-sm" placeholder="Description">{{ $location->location_desc }}</textarea>
	                    </div>
