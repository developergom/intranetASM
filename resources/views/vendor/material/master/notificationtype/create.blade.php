	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                    	<div class="radio m-b-15">
	                    		<label>
		                        	<input type="radio" name="notification_type_need_confirmation" value="1" {{ (old('notification_type_need_confirmation')=='1') ? 'checked' : '' }}>
	                    	...
	                    	<div class="radio m-b-15">
	                    		<label>
		                        	<input type="radio" name="notification_type_need_confirmation" value="0" {{ (old('notification_type_need_confirmation')=='0') ? 'checked' : '' }}>
		                        	<i class="input-helper"></i>
		                        	No
		                        </label>
	                    	</div>
