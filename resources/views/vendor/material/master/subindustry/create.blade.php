...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Sub Industries Management<small>Create New Sub Industry</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/subindustry') }}">
        		{{ csrf_field() }}
        		...
        		<div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="subindustry_code" id="subindustry_code" placeholder="Sub Industry Code" required="true" maxlength="10" value="{{ old('subindustry_code') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="subindustry_name" id="subindustry_name" placeholder="Sub Industry Name" required="true" maxlength="100" value="{{ old('subindustry_name') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="subindustry_desc" id="subindustry_desc" class="form-control input-sm" placeholder="Description">{{ old('subindustry_desc') }}</textarea>
	                    </div>
