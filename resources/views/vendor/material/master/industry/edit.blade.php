...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Industry Management<small>Edit Industry</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/industry/'.$industry->industry_id) }}">
        		{{ csrf_field() }}
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="industry_name" id="industry_name" placeholder="Industry Name" required="true" maxlength="100" value="{{ $industry->industry_name }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <textarea name="industry_desc" id="industry_desc" class="form-control input-sm" placeholder="Description">{{ $industry->industry_desc }}</textarea>
	                    </div>
