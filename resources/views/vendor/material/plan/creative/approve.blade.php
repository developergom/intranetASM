...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Creative Plans<small>Creative Plan Approval</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form"  method="POST" action="{{ url('plan/creativeplan/approve/' . $creative->flow_no . '/' . $creative->creative_id) }}">
        		{{ csrf_field() }}
