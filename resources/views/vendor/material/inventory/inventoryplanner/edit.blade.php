        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('inventory/inventoryplanner/' . $inventory->inventory_planner_id) }}">
        				...
        				<div class="fg-line">
	        				<select name="inventory_type_id" id="inventory_type_id" class="selectpicker" data-live-search="true" required="true">
	        					...
	        					@foreach($inventory_types as $row)
	        						{!! $selected = '' !!}
                                	@if($inventory->inventory_type_id==$row->inventory_type_id)
	                                	{!! $selected = 'selected' !!}
                                	@endif
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm input-mask" name="inventory_planner_deadline" id="inventory_planner_deadline" placeholder="e.g 17/08/1945" required="true" maxlength="10" value="{{ $inventory_deadline }}" autocomplete="off" data-mask="00/00/0000">
	                    </div>
