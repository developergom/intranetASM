        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('config/setting/'.$setting->setting_id) }}">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="setting_code" id="setting_code" placeholder="Setting Code" required="true" maxlength="100" value="{{ $setting->setting_code }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="setting_name" id="setting_name" placeholder="Setting Name" required="true" maxlength="100" value="{{ $setting->setting_name }}">
	                    </div>
