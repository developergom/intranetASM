...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Contract<small>Edit Contract</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('workorder/contract/' . $contract->contract_id) }}">
        		{{ csrf_field() }}
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="fg-line">
							<textarea name="contract_notes" id="contract_notes" class="form-control input-sm" placeholder="Contract Notes">{{ $contract->contract_notes }}</textarea>
						</div>
