...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Summary<small>Update Posisi Iklan</small></h2></div>
                                ...
                                @foreach($summary->summaryitems as $row)
                                    @if($row->revision_no == $summary->revision_no)
                                        ...
                                        @endif
                                            ...
                                            <td>
                                                <div class="fg-line">
                                                    <input type="hidden" name="summary_item_id[]" value="{{ $row->summary_item_id }}"><input type="text" style="width:120px;" name="page_no[]" class="form-control" value="{{ $row->page_no }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                                    <input type="text" style="width:120px;" name="summary_item_canal[]" class="form-control" value="{{ $row->summary_item_canal }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                                    <input type="text" style="width:120px;" name="summary_item_order_digital[]" class="form-control" value="{{ $row->summary_item_order_digital }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                                    <input type="text" style="width:120px;" name="summary_item_materi[]" class="form-control" value="{{ $row->summary_item_materi }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                                    <input type="text" style="width:120px;" name="summary_item_status_materi[]" class="form-control" value="{{ $row->summary_item_status_materi }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                                    <input type="text" style="width:120px;" name="summary_item_capture_materi[]" class="form-control" value="{{ $row->summary_item_capture_materi }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                            ...
                                            <td>
                                                <div class="fg-line">
                                                    <input type="hidden" name="summary_item_ppn[]" value="{{ (0.1*$row->summary_item_nett) }}">
                                                    <input type="text" style="width:120px;" name="format_summary_item_ppn[]" class="form-control" value="{{ number_format(0.1*$row->summary_item_nett) }}" readonly="true">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fg-line">
                                                    <input type="hidden" name="summary_item_total[]" value="{{ (1.1*$row->summary_item_nett) }}">
                                                    <input type="text" style="width:120px;" name="format_summary_item_total[]" class="form-control" value="{{ number_format(1.1*$row->summary_item_nett) }}" readonly="true">
                                                </div>
                                            </td>
                                        </tr>
                                    @endif
