...
<div class="form-group">
    <label for="letter_source" class="col-sm-2 control-label">Source</label>
    <div class="col-sm-10">
        <div class="fg-line">
            <input type="text" class="form-control input-sm" id="letter_source" readonly="true" value="{{ $letter->letter_source }}">
        </div>
    </div>
</div>
<div class="form-group">
