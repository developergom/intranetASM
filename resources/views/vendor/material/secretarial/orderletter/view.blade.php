...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <div class="fg-line">
            <input type="text" class="form-control input-sm" placeholder=Current User" readonly="true" maxlength="100" value="{{ $letter->_currentuser->user_firstname . ' ' . $letter->_currentuser->user_lastname }}">
        </div>
    </div>
</div>
<div class="form-group">
