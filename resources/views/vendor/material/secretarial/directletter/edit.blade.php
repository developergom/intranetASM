...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Direct Letter<small>Edit Direct Letter</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('secretarial/directletter/' . $letter->letter_id) }}">
        		{{ csrf_field() }}
